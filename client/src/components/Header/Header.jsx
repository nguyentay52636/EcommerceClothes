...
export function Header() {
  ...
  const navList = (
    <ul className=" lg:w-full mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant=""
  ...
  return (
    <Navbar className="mx-auto w-full max-w-full p-4 lg:rounded-md lg:pl-6 fixed top-0 left-0 right-0 z-[999]">
      ...
      <Typography className="mr-4 ml-2 cursor-pointer py-1.5 font-medium hover:animate-_zoomInOut">
         <image src="https://theme.hstatic.net/1000378223/1001264459/14/logo.png?v=503"  className="w-[500px] lg:w-full"   alt="benandto"/>
        </Typography>
